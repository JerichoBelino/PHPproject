                                        ...
                                        <tr>
											...
											<?php 
												if (isset($fetch['loan_id'])) {
													$details = $user->getNextPaymentDetails($fetch['loan_id'], $fetch['status'], $monthly, $penalty);
														...
														<div class="modal-body">
															<div class="form-row">
																<div class="form-group col-md-6">
																	...
																	<select name="borrower" class="borrow" required style="width:100%;">
																		<?php
																		foreach ($user->getBorrowers() as $borrower) {
																...
																<div class="form-group col-md-6">
																	...
																	<select name="ltype" class="loan" required style="width:100%;">
																		<?php
																			foreach ($user->getLoanTypes() as $loanType) {
															...
															<div class="form-row">
																<div class="form-group col-md-6">
																	...
																	<select name="lplan" class="form-control" required id="ulplan">
																		<?php
																			foreach ($user->getLoanPlans() as $loanPlan) {
																...
																<div class="form-group col-md-6">
																	...
																	<input type="number" name="loan_amount" class="form-control" id="uamount" value="<?php echo htmlspecialchars($fetch['amount']); ?>" required />
																</div>
															</div>
															<div class="form-row">
																<div class="form-group col-md-6">
																	<label>Purpose</label>
																	<textarea name="purpose" class="form-control" required><?php echo htmlspecialchars($fetch['purpose']); ?></textarea>
																</div>
																<div class="form-group col-md-6">
										...
										<div class="modal fade" id="deleteborrower<?php echo $fetch['loan_id']?>" tabindex="-1" aria-hidden="true">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer">
														<button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
														<a class="btn btn-danger" href="user_deleteLoan.php?loan_id=<?php echo $fetch['loan_id']?>">Delete</a>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div class="container">
															...
															<?php
																if (isset($fetch['loan_id'])) {
																	$scheduleData = $user->getLoanSchedule($fetch['loan_id']);
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-row">
							<div class="form-group col-md-6">
								...
								<select name="borrower" class="borrow" required style="width:100%;">
									<option value=""></option>
									<?php
										$tbl_borrower = $user->display_borrower();
										foreach ($tbl_borrower as $fetch) {
									?>
										<option value="<?php echo $fetch['borrower_id']?>">
											<?php echo $fetch['lastname'].", ".$fetch['firstname']." ".substr($fetch['middlename'], 0, 1); ?>.
										</option>
									<?php } ?>
								</select>
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Loan Plan</label>
								<select name="lplan" class="form-control" required id="lplan">
									<option value="">Please select an option</option>
									<?php
										$tbl_lplan = $user->display_lplan();
										foreach ($tbl_lplan as $fetch) {
									?>
										<option value="<?php echo $fetch['lplan_id']?>">
											<?php echo $fetch['lplan_month']." months[".$fetch['lplan_interest']."%, ".$fetch['lplan_penalty']."%]"; ?>
										</option>
									<?php } ?>
								</select>
							</div>
							<div class="form-group col-md-6">
								<label>Loan Amount</label>
								<input type="number" name="loan_amount" class="form-control" id="amount" required />
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Purpose</label>
								<textarea name="purpose" class="form-control" style="resize:none; height:200px;" required></textarea>
							</div>
							<div class="form-group col-md-6">
						...
						<div class="row" id="calcTable">
							<div class="col-md-4 text-center"><span>Total Payable</span><br><span id="tpa"></span></div>
							<div class="col-md-4 text-center"><span>Monthly Payable</span><br><span id="mpa"></span></div>
							<div class="col-md-4 text-center"><span>Penalty</span><br><span id="pa"></span></div>
						</div>
					</div>
					<div class="modal-footer">
						<button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
	...
	<script>
		...
		function calculateAmount(planSelector, amountSelector, tpa, mpa, pa) {
			if ($(planSelector).val() == "" || $(amountSelector).val() == "") {
				...
				months = parseInt(months.trim(), 10);
